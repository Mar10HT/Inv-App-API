...
export const PERMISSIONS = [
  ...
  {
    key: 'inventory:view_assigned',
    module: 'inventory',
    action: 'view_assigned',
    description: 'View only items assigned to the user (EXTERNAL)',
  },
  {
  ...
  },
  {
    ...
    module: 'users',
    action: 'delete',
    description: 'Delete users (SYSTEM_ADMIN / HR only)',
  },
  // transactions
  {
  ...
  // stocktake
  {
    ...
    module: 'stocktake',
    action: 'view',
    description: 'View stock takes',
  },
  {
    key: 'stocktake:create',
    module: 'stocktake',
    action: 'create',
    description: 'Create stock takes',
  },
  {
    key: 'stocktake:manage',
    module: 'stocktake',
    action: 'manage',
    description: 'Complete / cancel stock takes',
  },
  // transfers
  {
    key: 'transfers:view',
  ...
  },
  {
    ...
    module: 'transfers',
    action: 'manage',
    description: 'Approve / reject transfer requests',
  },
  // loans
  {
    key: 'loans:view',
  ...
  },
  {
    ...
    module: 'loans',
    action: 'manage',
    description: 'Confirm receipt / return of loans',
  },
  // discharges
  {
    key: 'discharges:view',
    module: 'discharges',
    action: 'view',
    description: 'View discharge requests',
  },
  {
    key: 'discharges:create',
    module: 'discharges',
    action: 'create',
    description: 'Create discharge requests',
  },
  {
    key: 'discharges:manage',
    module: 'discharges',
    action: 'manage',
    description: 'Resolve discharge requests',
  },
  // outflows (salidas / write-offs)
  {
    ...
    module: 'outflows',
    action: 'view',
    description: 'View outflows (write-offs)',
  },
  {
    key: 'outflows:create',
    module: 'outflows',
    action: 'create',
    description: 'Create outflows (write-offs)',
  },
  {
    key: 'outflows:cancel',
    module: 'outflows',
  ...
  },
  {
    ...
    module: 'alerts',
    action: 'manage',
    description: 'Resolve / mark alerts as notified',
  },
  // transactions (extended)
  {
    ...
    module: 'transactions',
    action: 'delete',
    description: 'Delete transactions (SYSTEM_ADMIN only)',
  },
  // loans (extended)
  {
    key: 'loans:delete',
    module: 'loans',
    action: 'delete',
    description: 'Delete loans (SYSTEM_ADMIN only)',
  },
  // settings
  {
    key: 'settings:view',
  ...
  // auth admin — intentionally not assigned to any role; SYSTEM_ADMIN bypasses the check
  {
    ...
    action: 'admin',
    description:
      'Perform privileged auth operations (password resets, admin links)',
  },
] as const;
...
export const ROLE_PERMISSIONS: Record<string, PermissionKey[]> = {
  ...
  EXTERNAL: ['inventory:view_assigned', 'alerts:view'],
};
...
export const INITIAL_ROLES = [
  ...
  },
  {
    ...
    description: 'Manages inventory, warehouses, and operations.',
  },
  {
    name: 'USER',
  ...
  },
  {
    name: 'EXTERNAL',
    displayName: 'Externo',
    description: 'Minimal access for external users or contractors.',
  },
] as const;
