...
export const PERMISSIONS = [
  ...
  { key: 'sales:create',            module: 'sales',         action: 'create',        description: 'Create sales (decrements stock)' },
  { key: 'sales:cancel',            module: 'sales',         action: 'cancel',        description: 'Cancel sales and restore stock' },
  // reports
